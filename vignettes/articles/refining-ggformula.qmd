...
<script type="module">
  import { WebR } from 'https://r-wasm.org';
...
```{webr}
#| setup: true
#| exercise: ["multiple-variable-quickhelp", "ribbon-to-linerange", "labs-demo", "labels", "scales", "scales2", "scales3", "brewer", "flip-violin", "coord_equal", "coord_trans", "violinh", "horizontal", "filter", "gf_lims", "scale_lims", "gf_theme", "gf_theme_elements", "q_theme", "histogram-stat", "summary1", "summary3", "mean_se", "three-number"]
#| autorun: true
#| edit: false
#| output: false
library(tibble)
