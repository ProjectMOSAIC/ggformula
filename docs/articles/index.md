...
- [Extending {ggformula}](extending-ggformula.md):
- [ggformula: Another Option for Teaching Graphics in R to
  Beginners](pkgdown/ggformula-blog.md):
- [Formula Interface for ggplot2 (full
  version)](pkgdown/ggformula-long.md):
- [Formula Interface for {ggplot2}](ggformula.md):
