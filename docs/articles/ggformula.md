...
To learn more about `ggformula`, see the longer version of this vignette
available at <https://www.mosaic-web.org/ggformula/>. That version
include sections on
