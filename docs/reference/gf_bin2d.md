...
uses
[`ggplot2::stat_bin2d()`](https://ggplot2.tidyverse.org/reference/geom_bin_2d.html)
to bin the data before using [`gf_tile()`](gf_tile.md) to display the
results. `gf_bin_2d()` is an alias.
