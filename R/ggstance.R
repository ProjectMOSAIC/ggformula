...
#' gf_propsh(substance ~ ., data = mosaicData::HELPrct, fill = ~sex, position = position_dodgev())
#' gf_props(substance ~ ., data = mosaicData::HELPrct, fill = ~sex, position = position_dodge(), orientation = 'y')
